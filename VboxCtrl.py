...
class VboxControl():
    ...
    #结构:[VM_Name(str),Bus(int)(搭配常数字典StorageBus),ControllerType(int)(搭配常数字典StorageControllerType),useHostIOCache(bool)]
    ...
    def machine_poweron(self,listset):
        try:
            ...
            #集合相减,得到此次运行虚拟机而运行的VirtualBox.exe的进程的PID号
